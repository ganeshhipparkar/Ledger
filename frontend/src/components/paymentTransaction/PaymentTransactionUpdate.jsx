...
export default function PaymentTransactionUpdate({ id }) {
    const router = useRouter();
    const { displayUser } = useContext(loginContext) || {};
    const config = paymentTransactionFormConfig.contexts["payment-transaction-update"];
    ...
    const fetchDetails = async () => {
        ...
        try {
            const res = await fetch("/relayapi", {
                ...
                headers: {
                    ...authHeaders(),
                    endpoint: `payment-transaction-details/${numericId}`,
            ...
            toast.error("Failed to load payment transaction details.", { position: "top-right" });
        } finally {
            setFetching(false);
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            fd.append("paymentTransactionId", String(numericId));
    ...
    if (fetching) {
        return (
            <div className="min-h-screen w-full bg-[#f5f6f8] text-black">
                <Header page="payment-transaction-update" />
        ...
        <div className="min-h-screen w-full bg-[#f5f6f8] text-black">
            ...
            <div className="px-6 py-4">
                <div className="mb-6 flex items-center justify-between">
                    <h1 className="text-2xl font-bold text-gray-800">Edit Payment Transaction</h1>
                </div>
                        ...
                        {isSuperAdmin && (
                            <div className="mb-4">
                                ...
                                <select
                                    ...
                                    disabled
                                    className={`${selectClass("companyId")} cursor-not-allowed bg-gray-100`}
                                >
