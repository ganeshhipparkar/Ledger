        ...
        <div className="space-y-4">
            <div className="rounded-2xl bg-white border border-gray-200 shadow-sm p-5">
                ...
                <Row
                    ...
                    value={fmt(totals.qExtraCharge ?? qExtraCharge)}
                    action={() => setExtraChargePanelOpen(true)}
                />
                <Row
                    label="Less / Discount"
                    value={`− ${fmt(totals.qDiscount ?? qDiscount)}`}
            ...
            <QuotationLevelAdjSidePanel
                isOpen={discountPanelOpen}
                onClose={() => setDiscountPanelOpen(false)}
                type="discount"
                lines={quotationDiscounts}
                maxAmount={grossAmount + taxAmount + qExtraCharge}
